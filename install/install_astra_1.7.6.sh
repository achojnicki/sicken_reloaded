...
run "python3.11 -m pip install numpy openai flask flask-socketio python-socketio psutil tabulate colored pymongo eventlet pyyaml pika uwsgi websockets wxpython mistune eventlet"
...
run "mkdir /opt/sicken_reloaded/files/sicken"
run "mkdir /opt/sicken_reloaded/files/sicken/speech"
run "chmod -R 755 /opt/sicken_reloaded/bin "
