...
run "python3.13 -m pip install --break-system-packages numpy openai flask flask-socketio python-socketio psutil tabulate colored pymongo pyyaml pika uwsgi websockets wxpython mistune eventlet"
