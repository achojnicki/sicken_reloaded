...
run "brew trust --formula mongodb/brew/mongodb-community@8.0"
run "brew update"
...
run "/opt/homebrew/sbin/rabbitmqctl add_user sicken-llamacpp_llm password"
run "/opt/homebrew/sbin/rabbitmqctl add_user sicken-deepseek_llm password"
run "/opt/homebrew/sbin/rabbitmqctl add_user sicken-mistral_llm password"
...
/opt/homebrew/sbin/rabbitmqctl set_permissions -p / sicken-llamacpp_llm ".*" ".*" ".*"
/opt/homebrew/sbin/rabbitmqctl set_permissions -p / sicken-deepseek_llm ".*" ".*" ".*"
/opt/homebrew/sbin/rabbitmqctl set_permissions -p / sicken-mistral_llm ".*" ".*" ".*"
...
/opt/homebrew/sbin/rabbitmqctl set_topic_permissions sicken-llamacpp_llm "" ".*" ".*"
/opt/homebrew/sbin/rabbitmqctl set_topic_permissions sicken-deepseek_llm "" ".*" ".*"
/opt/homebrew/sbin/rabbitmqctl set_topic_permissions sicken-mistral_llm "" ".*" ".*"
