...
run "py -3.12 -m pip install --break-system-packages numpy openai eventlet flask flask-socketio python-socketio psutil tabulate colored pymongo pyyaml pika websockets twitchapi wxpython websocket-client mistune eventlet"
